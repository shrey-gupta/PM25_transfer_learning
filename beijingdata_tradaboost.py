################################################################################
###### This code is used for UCI beijing dataset: TrAdaBoost.R2 ################
################################# Header files #################################
...
path_beijing = r'/home/parulsharma/shrey/Beijing_AQI/PRSA_Data_20130301-20170228/' ## Path for all the files
...
with open('/home/parulsharma/shrey/Beijing_AQI/Results/TrAdaBoostO3_R2_std_clust.txt', 'w') as filehandle1:
    for listitem in r2scorelist:
        filehandle1.write('%s\n' % listitem)

with open('/home/parulsharma/shrey/Beijing_AQI/Results/TrAdaBoostO3_RMSE_std_clust.txt', 'w') as filehandle2:
    for listitem in rmselist:
        filehandle2.write('%s\n' % listitem)

with open('/home/parulsharma/shrey/Beijing_AQI/Results/TrAdaBoostO3_prediction_std_clust.txt', 'w') as filehandle3:
